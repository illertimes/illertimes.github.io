  ...
  $.get(weatherUrl + 'New York City')
    .fail(function (xhr) {
  	...
  	function colorBackground (temp) {
  		if (temp > 70) {
  			$('body').css('background', 'https://www.osfashland.org/~/media/Content-Masthead-Folder/WeatherMH47.ashx?as=1&h=308&la=en&w=746&hash=88B4BF08C1D40F898E4AD0E7EFA866F20C831F87');
  		} else {
